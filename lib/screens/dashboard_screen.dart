...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _getUserName() {
    try {
      ...
      _userName = authProvider.user?.name ?? 'User';
    } catch (e) {
      _userName = 'User';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Squats in last 7 Days', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: kTextPrimary)),
          const SizedBox(height: 16),
          SizedBox(
            height: 120,
            child: Row(
...
class _RecommendedWorkoutSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Recommended Workout', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: kTextPrimary)),
