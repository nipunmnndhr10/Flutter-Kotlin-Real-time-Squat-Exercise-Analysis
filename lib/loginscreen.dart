...
class _LoginScreenState extends State<LoginScreen>
  ...
  // Validation moved to lib/validators.dart
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final availableHeight = media.size.height -
                ...
                kToolbarHeight;
            final heroHeight = (availableHeight * 0.36).clamp(180.0, 340.0);
            ...
            return SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  // Form area takes remaining space and scales to fit
                  SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Inputs and buttons grouped and do not expand
                              Flexible(
                                flex: 0,
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InputField(
                                      ...
                                      onChanged: (v) => setState(() {
                                        _passwordError = validatePassword(v);
                                      }),
